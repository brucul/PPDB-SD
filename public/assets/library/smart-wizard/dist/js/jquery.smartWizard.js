  ...
  var SmartWizard = /*#__PURE__*/function () {
    ...
    _createClass(SmartWizard, [{
      ...
      value: function _createToolbar(position) {
        ...
        var btnNext = this.options.toolbar.showNextButton !== false ? $('<button></button>').html(this.options.lang.next + ' <i class="fa fa-arrow-circle-right"></i>').addClass('btn ' + this.options.style.btnNextCss + ' ' + this.options.style.btnCss).attr('type', 'button') : null;
        var btnPrevious = this.options.toolbar.showPreviousButton !== false ? $('<button></button>').html('<i class="fa fa-arrow-circle-left"></i> ' + this.options.lang.previous).addClass('btn ' + this.options.style.btnPrevCss + ' ' + this.options.style.btnCss).attr('type', 'button') : null;
